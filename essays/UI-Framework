...
In addition to helping with simple formatting and classes with Semantic Ui, many different icons are made available to help jumpstart any webpage with the necessary icons like email, facebook and various social media links. All can be added simply by using <i></i> and setting it's class to "search icon" or whatever icon you need. Many of them are easy to get like mail icon so really easy to set up a page with lots of links really quick with Semantic Ui. 
